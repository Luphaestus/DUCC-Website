 ...
 */
export async function renderManageQuotes() {
 ...
 */
function updateQuoteParams(updates) {
 ...
 */
async function fetchAndRenderAdminQuotes({ page, search, sort, order }) {
    ...
    try {
        const query = new URLSearchParams({ page, limit: 15, search, sort, order });
        ...
        new Pagination(document.getElementById('quotes-pagination'), (newPage) => {
