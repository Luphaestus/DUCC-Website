...
export default class AttendanceDB {
     ...
     */
    static async is_user_attending_event(db: DatabaseWrapper, userId: number, eventId: number): Promise<statusObject> {
     ...
     */
    static async attend_event(db: DatabaseWrapper, userId: number, eventId: number, transactionId: number | null = null): Promise<statusObject> {
     ...
     */
    static async leave_event(db: DatabaseWrapper, userId: number, eventId: number): Promise<statusObject> {
        const isAttending = await this.is_user_attending_event(db, userId, eventId);
        if (isAttending.isError()) return isAttending;
     ...
     */
    static async get_all_event_attendees_history(db: DatabaseWrapper, eventId: number): Promise<statusObject> {
        try {
     ...
     */
    static async get_users_attending_event(db: DatabaseWrapper, eventId: number): Promise<statusObject> {
        const sql = `
     ...
     */
    static async get_event_attendance_count(db: DatabaseWrapper, eventId: number): Promise<statusObject> {
     ...
     */
    static async get_event_refund_id(db: DatabaseWrapper, userId: number, eventId: number): Promise<statusObject> {
     ...
     */
    static async refundEvent(db: DatabaseWrapper, eventId: number, user_id: number): Promise<statusObject> {
     ...
     */
    static async isUserPayingForEvent(db: DatabaseWrapper, userId: number, eventId: number): Promise<statusObject> {
     ...
     */
    static async getCoachesAttendingCount(db: DatabaseWrapper, eventId: number): Promise<number> {
     ...
     */
    static async removeAllAttendees(db: DatabaseWrapper, eventId: number): Promise<void> {
