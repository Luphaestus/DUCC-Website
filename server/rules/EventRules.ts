...
export default class EventRules {
     ...
     */
    static async canViewEvent(db: DatabaseWrapper, event: any, user: any): Promise<boolean> {
     ...
     */
    static async canJoinEvent(db: DatabaseWrapper, event: any, user: any): Promise<statusObject> {
     ...
     */
    static async canViewImage(db: DatabaseWrapper, imageId: number | string, user: any): Promise<boolean> {
