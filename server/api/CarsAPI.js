...
export default class CarsAPI {
    ...
    registerRoutes() {
        ...
        /** Add a new car. */
        this.app.post('/api/cars', checkAuthentication(), async (req, res) => {
        ...
        /** Update a car. */
        this.app.put('/api/cars/:id', checkAuthentication(), async (req, res) => {
            const { id } = req.params;
            const { name, seats, boats, isGlobal } = req.body;
            const userId = req.user.id;
            ...
            const car = (carsRes.getData() || []).find(c => c.id == id);
        ...
        /** Remove a car. */
        this.app.delete('/api/cars/:id', checkAuthentication(), async (req, res) => {
            const { id } = req.params;
            const userId = req.user.id;
        ...
        this.app.post('/api/drivers/:id/mileage', checkAuthentication(), async (req, res) => {
            const { id } = req.params;
