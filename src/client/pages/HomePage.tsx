  ...
  return (
    <div id="home-view" class="view">
      <div class="hero">
        ...
        <div class="hero-offer" use:mos data-mos="fade-up">
          <div class="hero-offer-boxes">
            <div class="hero-offer-box-wrapper" use:mos data-mos="zoom-in">
      ...
      <div class="small-container">
        <div class="glass-section" use:mos data-mos="slide-up">
        ...
        <div class="glass-section" use:mos data-mos="zoom-in">
