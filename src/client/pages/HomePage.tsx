...
export default function HomePage() {
  ...
  return (
    <div id="home-view" class="view">
      <div class="hero">
        <div class="slide show" style={{ "--slide-img-url": layers()[0] ? `url("${layers()[0]}")` : 'none', opacity: activeLayer() === 0 ? 1 : 0, transition: 'opacity 1s ease-in-out', position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}></div>
        <div class="slide show" style={{ "--slide-img-url": layers()[1] ? `url("${layers()[1]}")` : 'none', opacity: activeLayer() === 1 ? 1 : 0, transition: 'opacity 1s ease-in-out', position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}></div>
        
        <div class="hero-title" use:mos data-mos="fade-up">
        ...
        <div class="hero-offer">
          ...
          <div class="hero-offer-boxes">
            <div class="hero-offer-box" use:mos data-mos="zoom-in">
      ...
      <div class="small-container">
        <h1>About Us</h1>
        <div class="about-us-para" use:mos data-mos="slide-up">
        ...
        <div class="find-us-para" use:mos data-mos="zoom-in">
