 ...
 */
export function initConditionalRadio(yesId: string, noId: string, detailId: string) {
    const yesBtn: HTMLInputElement | null = document.getElementById(yesId) as HTMLInputElement;
    const noBtn: HTMLInputElement | null = document.getElementById(noId) as HTMLInputElement;
    const detailInput: HTMLInputElement | null = document.getElementById(detailId) as HTMLInputElement;
