...
export class Tag {
     ...
     */
    static getContrastColour(hexColour: string): string {
     ...
     */
    static render(tag: { name: string; color?: string }, extraClasses = '', extraStyles = '') {
     ...
     * @returns {string} HTML string.
     */
    static renderList(tags: { name: string; color?: string }[], extraClasses = '') {
