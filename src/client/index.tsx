...
const UnauthorisedPage = lazy(() => import("./pages/ErrorPage").then(m => ({ default: m.UnauthorisedPage })));
const NoInternetPage = lazy(() => import("./pages/ErrorPage").then(m => ({ default: m.NoInternetPage })));
